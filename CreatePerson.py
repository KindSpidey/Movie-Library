...
# Form implementation generated from reading ui file 'CreatePerson.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.moviesEdit = QtWidgets.QTextEdit(self.widget)
        font = QtGui.QFont()
        font.setFamily("Open Sans")
        font.setPointSize(10)
        self.moviesEdit.setFont(font)
        self.moviesEdit.setFrameShape(QtWidgets.QFrame.Panel)
        self.moviesEdit.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.moviesEdit.setObjectName("moviesEdit")
        self.gridLayout_2.addWidget(self.moviesEdit, 8, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.head.setText(_translate("Form", "Добавление"))
        self.label_5.setText(_translate("Form", "Телефон"))
        self.addSalaryButton.setText(_translate("Form", "Добавить зарплату"))
        self.nameEdit.setPlaceholderText(_translate("Form", "Имя и фамилия человека"))
        self.moviesEdit.setPlaceholderText(_translate("Form", "Полные названия всех фильмов через запятую"))
        self.saveButton.setText(_translate("Form", "Сохранить"))
        self.label_2.setText(_translate("Form", "Человек"))
        self.emailEdit.setPlaceholderText(_translate("Form", "Почта"))
        self.label_4.setText(_translate("Form", "e-mail"))
        self.label_7.setText(_translate("Form", "Фильмы"))
        self.phoneEdit.setPlaceholderText(_translate("Form", "Телефон"))
